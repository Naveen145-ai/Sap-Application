...
const Home = () => {
  ...
  const [mentorEmail, setMentorEmail] = useState(localStorage.getItem('mentorEmail') || ''); // Get from localStorage
          ...
          <div style={{ marginTop: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
            {emailInputMode ? (
              <>
                ...
                <button
                  onClick={() => {
                    localStorage.setItem('mentorEmail', mentorEmail); // ✅ Save to localStorage
